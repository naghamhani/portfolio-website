...
const GITHUB_PROFILE = "https://github.com/naghamhani";
                    ...
                    <div className={`grid items-stretch gap-8 pb-10 pt-2 transition-opacity duration-500 lg:grid-cols-[1fr_1.05fr] lg:gap-14 ${open ? "opacity-100" : "opacity-0"}`}>
                      ...
                      <div className="flex flex-col justify-center">
                        ...
                        <div className="flex flex-wrap items-center gap-x-6 gap-y-3">
                          ...
                          <a href={proj.github || GITHUB_PROFILE} target="_blank" rel="noopener noreferrer" className="inline-flex w-fit items-center gap-2 rounded-full border border-paper/25 px-4 py-2 font-mono text-[13px] font-medium text-paper/80 transition hover:border-paper hover:text-paper">
